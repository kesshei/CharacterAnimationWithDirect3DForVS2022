...
D3DXMATRIX BT2DX_MATRIX(const btTransform &ms)
{
	...
	D3DXQUATERNION f = BT2DX_QUATERNION(q);
	D3DXMatrixRotationQuaternion(&rot, &f);
...
void PhysicsEngine::Reset()
{
	...
	for(int i=0; i<100; i++)
	{	
		D3DXVECTOR3 a1 = D3DXVECTOR3(-10.0f, 0.0f, -10.0f);
		D3DXVECTOR3 a2 = D3DXVECTOR3(10.0f, 50.0f, 10.0f);
		D3DXVECTOR3 a3 = D3DXVECTOR3(0.5f, 0.5f, 0.5f);
		D3DXVECTOR3 a4 = D3DXVECTOR3(10.0f, 50.0f, 10.0f);
		m_boxes.push_back(CreateOBB(RandomVector(a1, a2),
									RandomVector(a3, a4)));
	}
}
